...
let s:p.inactive.left =  [ [ s:nord5, s:nord1 ], [ s:nord5, s:nord1 ] ]
...
let s:p.insert.left = [ [ s:nord1, s:nord14, 'bold' ], [ s:nord5, s:nord1 ] ]
let s:p.replace.left = [ [ s:nord1, s:nord13, 'bold' ], [ s:nord5, s:nord1 ] ]
let s:p.visual.left = [ [ s:nord1, s:nord7, 'bold' ], [ s:nord5, s:nord1 ] ]
