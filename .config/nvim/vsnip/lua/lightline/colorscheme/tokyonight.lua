...
tokyonight.normal = {
  left = {{ colors.black, colors.blue, 'bold' }, { colors.blue, colors.fg_gutter }},
...
tokyonight.insert = {
  left = {{ colors.black, colors.green, 'bold' }, { colors.blue, colors.fg_gutter }},
}

tokyonight.visual = {
  left = {{ colors.black, colors.magenta, 'bold' }, { colors.blue, colors.bg }},
}

tokyonight.replace = {
  left = {{ colors.black, colors.red, 'bold' }, { colors.blue, colors.bg }},
}
